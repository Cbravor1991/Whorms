...
public:
    ...
    void setupUi(QDialog *JoinPopUp)
    {
        ...
        JoinPopUp->setStyleSheet(QString::fromUtf8("background-image: url(:negro_fondo.jpg);"));
        ...
        games->setMinimumSize(QSize(320, 0));
    ...
    void retranslateUi(QDialog *JoinPopUp)
    {
        ...
        createButton->setText(QCoreApplication::translate("JoinPopUp", "EDITAR MAPA", nullptr));
